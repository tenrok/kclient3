/* ============================================================
* KDEFrameworksIntegration - KDE support plugin for KClient
...
void KWalletPasswordBackend::removeAll()
{
    ...
    m_wallet->removeFolder("KClient");
    m_wallet->createFolder("KClient");
}
...
void KWalletPasswordBackend::initialize()
{
    ...
    bool migrate = !m_wallet->hasFolder("KClient") && m_wallet->hasFolder("QupZilla");

    if (!m_wallet->hasFolder("KClient") && !m_wallet->createFolder("KClient")) {
        qWarning() << "KWalletPasswordBackend::initialize Cannot create folder \"KClient\"!";
        return;
    }
    ...
    if (migrate) {
        ...
        if (!m_wallet->setFolder("KClient")) {
            qWarning() << "KWalletPasswordBackend::initialize Cannot set folder \"KClient\"!";
            return;
        }
    }
