var GM={info:{script:{description:"",excludes:[],includes:[],matches:[],name:"",namespace:"",resources:{},"run-at":"document-end",version:""},scriptMetaStr:"",scriptHandler:"KClient GreaseMonkey",version:"4.0"}};window.GM=GM;function GM_info(){return GM.info}
