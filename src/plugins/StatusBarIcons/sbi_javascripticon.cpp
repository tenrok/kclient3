/* ============================================================
* StatusBarIcons - Extra icons in statusbar for KClient
...
void SBI_JavaScriptIcon::showMenu(const QPoint &point)
{
    ...
    // JavaScript needs to be always enabled for kclient: sites
    if (currentPage() && currentPage()->url().scheme() == QLatin1String("kclient")) {
