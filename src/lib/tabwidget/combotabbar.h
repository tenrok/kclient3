...
class KCLIENT_EXPORT ComboTabBar : public QWidget
{
    Q_OBJECT
...
class KCLIENT_EXPORT TabBarHelper : public QTabBar
{
    Q_OBJECT
...
class KCLIENT_EXPORT TabScrollBar : public QScrollBar
{
    Q_OBJECT
public:
...
class KCLIENT_EXPORT TabBarScrollWidget : public QWidget
{
    Q_OBJECT
public:
