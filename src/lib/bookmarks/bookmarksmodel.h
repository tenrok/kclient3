...
class KCLIENT_EXPORT BookmarksModel : public QAbstractItemModel
{
    Q_OBJECT
...
class KCLIENT_EXPORT BookmarksFilterModel : public QSortFilterProxyModel
{
    Q_OBJECT
...
class KCLIENT_EXPORT BookmarksButtonMimeData : public QMimeData
{
    Q_OBJECT
