...
class KCLIENT_EXPORT BookmarksFoldersMenu : public QMenu
{
    Q_OBJECT
...
class KCLIENT_EXPORT BookmarksFoldersButton : public QPushButton
{
    Q_OBJECT
...
class KCLIENT_EXPORT BookmarksTools
{
public:
