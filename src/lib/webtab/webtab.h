...
class KCLIENT_EXPORT WebTab : public QWidget
{
    Q_OBJECT
public:
    struct KCLIENT_EXPORT SavedTab {
        QString title;
        QUrl url;
        QIcon icon;
        QByteArray history;
        ...
        friend KCLIENT_EXPORT QDataStream &operator<<(QDataStream &stream, const SavedTab &tab);
        friend KCLIENT_EXPORT QDataStream &operator>>(QDataStream &stream, SavedTab &tab);
    };
