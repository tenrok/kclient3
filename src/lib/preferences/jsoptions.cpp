    ...
    , ui(new Ui::JsOptions)
{
    ...
    ui->jscanOpenWindow->setChecked(settings.value("allowJavaScriptOpenWindow", true).toBool());
    ui->jscanActivateWindow->setChecked(settings.value("allowJavaScriptActivateWindow", true).toBool());
