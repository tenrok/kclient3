...
struct KCLIENT_EXPORT RestoreData
{
    ...
    friend KCLIENT_EXPORT QDataStream &operator<<(QDataStream &stream, const RestoreData &data);
    friend KCLIENT_EXPORT QDataStream &operator>>(QDataStream &stream, RestoreData &data);
};

class KCLIENT_EXPORT RestoreManager
{
public:
