...
static const bool kEnableJsOutput = qEnvironmentVariableIsSet("KCLIENT_ENABLE_JS_OUTPUT");
static const bool kEnableJsNonBlockDialogs = qEnvironmentVariableIsSet("KCLIENT_ENABLE_JS_NONBLOCK_DIALOGS");
...
void WebPage::handleUnknownProtocol(const QUrl &url)
{
    ...
    const QString text = tr("KClient cannot handle <b>%1:</b> links. The requested link "
                            "is <ul><li>%2</li></ul>Do you want KClient to try "
