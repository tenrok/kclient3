...
#ifdef KCLIENT_SHAREDLIBRARY
#define KCLIENT_EXPORT Q_DECL_EXPORT
#else
#define KCLIENT_EXPORT Q_DECL_IMPORT
#endif
...
KCLIENT_EXPORT extern const char *APPNAME;
KCLIENT_EXPORT extern const char *VERSION;
KCLIENT_EXPORT extern const char *AUTHOR;
KCLIENT_EXPORT extern const char *COPYRIGHT;
KCLIENT_EXPORT extern const char *WWWADDRESS;
KCLIENT_EXPORT extern const char *BUGSADDRESS;
KCLIENT_EXPORT extern const char *WIKIADDRESS;
