...
class KCLIENT_EXPORT BrowserWindow : public QMainWindow
{
    Q_OBJECT
...
public:
    struct SavedWindow {
        ...
        friend KCLIENT_EXPORT QDataStream &operator<<(QDataStream &stream, const SavedWindow &window);
        friend KCLIENT_EXPORT QDataStream &operator>>(QDataStream &stream, SavedWindow &window);
    };
