...
{
    if (m_window) {
        m_window->tabWidget()->addView(QUrl(QSL("kclient:about")), Qz::NT_CleanSelectedTab);
    }
}
...
{
    if (m_window) {
        m_window->tabWidget()->addView(QUrl(QSL("kclient:config")), Qz::NT_CleanSelectedTab);
    }
}
...
{
    if (m_window) {
        m_window->tabWidget()->addView(QUrl(QSL("kclient:reportbug")), Qz::NT_CleanSelectedTab);
    }
}
