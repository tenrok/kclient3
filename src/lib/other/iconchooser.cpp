...
{
    const QString fileTypes = QString("%3 (*.png *.jpg *.jpeg *.gif)").arg(tr("Файлы изображений"));
    const QString path = QzTools::getOpenFileName("IconChooser-ChangeIcon", this, tr("Выберите иконку..."), QDir::homePath(), fileTypes);
