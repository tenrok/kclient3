...
class ActionManager(QtCore.QObject):
    ...
    def execAction(self, action, webView, url, text=""):
        ...
        if action.actionType == Action.Type.Command:
            ...
            webView.openUrlInNewTab(QtCore.QUrl(command), KClient.Qz.NT_SelectedTab)
