...
void kclient_signal_handler(int s)
{
    if (s != SIGSEGV) {
        return;
    }
    ...
    std::cout << "KClient: Crashed :( Saving backtrace in " << qPrintable(DataPaths::path(DataPaths::Config)) << "/crashlog ..." << std::endl;
    ...
    stream << "KClient version: " << Qz::VERSION << endl;
...
int main(int argc, char* argv[])
{
    ...
    signal(SIGSEGV, kclient_signal_handler);
#endif
